...
class SSEPendingTrackingPrioritizingArticleQueue extends Component {
...
export default connect(mapStateToProps, actions)(SSEPendingTrackingPrioritizingArticleQueue);

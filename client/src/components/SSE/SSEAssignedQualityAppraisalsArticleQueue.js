...
class SSEAssignedQualityAppraisalsArticleQueue extends Component {

    componentDidMount() {
        this.props.listSSEAssignedQualityAppraisalsArticlesQueue();
    }
...
function mapStateToProps({ sseAssignedQualityAppraisalsArticleQueue }) {
    return {
        errorMessage: sseAssignedQualityAppraisalsArticleQueue.sseAssignedQualityAppraisalsArticleErrorMessage,
        assignedArticles: sseAssignedQualityAppraisalsArticleQueue.sseAssignedQualityAppraisalsArticles 
    }
}

export default connect(mapStateToProps, actions)(SSEAssignedQualityAppraisalsArticleQueue);

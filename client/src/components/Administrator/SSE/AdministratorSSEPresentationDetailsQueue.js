/**
 * @name AdministratorSSEPresentationDetailsQueue.js
 * @author Kwadwo Sakyi
 * @description Defines the administrator's presentation details queue copmonent
 */
...
class AdministratorSSEPresentationDetailsQueue extends Component {
...
function mapStateToProps({ administratorSSEPresentationDetailsQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorSSEPresentationDetailsQueue.administratorSSEPresentationDetailsQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorSSEPresentationDetailsQueue);

/**
 * @name AdministratorSSEQualityAppraisalsQueue.js
 * @author Kwadwo Sakyi
 * @description Defines the administrator's quality appraisals queue copmonent
 */
...
class AdministratorSSEQualityAppraisalsQueue extends Component {
...
function mapStateToProps({ administratorSSEQualityAppraisalsQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorSSEQualityAppraisalsQueue.administratorSSEQualityAppraisalsQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorSSEQualityAppraisalsQueue);

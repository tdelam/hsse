...
class AdministratorSSEGoLiveQueue extends Component {
...
function mapStateToProps({ administratorSSEGoLiveQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorSSEGoLiveQueue.administratorSSEGoLiveQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorSSEGoLiveQueue);

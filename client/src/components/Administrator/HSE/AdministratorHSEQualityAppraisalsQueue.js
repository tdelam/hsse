...
class AdministratorHSEQualityAppraisalsQueue extends Component {
...
function mapStateToProps({ administratorHSEQualityAppraisalsQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorHSEQualityAppraisalsQueue.administratorHSEQualityAppraisalsQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorHSEQualityAppraisalsQueue);

...
class HSEPendingTranslatingTitlesArticleQueue extends Component {
...
function mapStateToProps({ hsePendingTranslatingTitlesArticleQueue }) {
    return { 
        errorMessage: hsePendingTranslatingTitlesArticleQueue.hsePendingTranslatingTitlesErrorMessage,
        pendingArticles: hsePendingTranslatingTitlesArticleQueue.hsePendingTranslatingTitlesArticles 
    }
}

export default connect(mapStateToProps, actions)(HSEPendingTranslatingTitlesArticleQueue);

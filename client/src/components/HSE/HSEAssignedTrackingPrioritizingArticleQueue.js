...
class HSEAssignedTrackingPrioritizingArticleQueue extends Component {
...
function mapStateToProps({ hseAssignedTrackingPrioritizingArticleQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: hseAssignedTrackingPrioritizingArticleQueue.hseAssignedTrackingPrioritizingArticleErrorMessage,
        assignedArticles: hseAssignedTrackingPrioritizingArticleQueue.hseAssignedTrackingPrioritizingArticles 
    }
}

export default connect(mapStateToProps, actions)(HSEAssignedTrackingPrioritizingArticleQueue);

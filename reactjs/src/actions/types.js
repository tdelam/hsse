...
export const SSE_ASSIGNED_LINKING_STUDIES_QUEUE = 'sse_assigned_linking_studies_queue';
export const SSE_ASSIGNED_LINKING_STUDIES_QUEUE_ERROR = 'sse_assigned_linking_studies_queue_error';

export const SSE_ASSIGNED_PRESENTATION_DETAILS_QUEUE = 'sse_assigned_presentation_details_queue';
export const SSE_ASSIGNED_PRESENTATION_DETAILS_QUEUE_ERROR = 'sse_assigned_presentation_details_queue_error';

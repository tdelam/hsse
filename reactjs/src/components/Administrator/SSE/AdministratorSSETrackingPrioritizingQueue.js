...
class AdministratorSSETrackingPrioritizingQueue extends Component {
...
function mapStateToProps({ administratorSSETrackingPrioritizingQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorSSETrackingPrioritizingQueue.administratorSSETrackingPrioritizingQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorSSETrackingPrioritizingQueue);

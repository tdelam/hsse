/**
 * @name AdministratorHSETrackingPrioritizingQueue.js
 * @author Kwadwo Sakyi
 * @description Defines the administrator's tracking and prioritizing queue component
 */
...
class AdministratorHSETrackingPrioritizingQueue extends Component {
...
function mapStateToProps({ administratorHSETrackingPrioritizingQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorHSETrackingPrioritizingQueue.administratorHSETrackingPrioritizingQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorHSETrackingPrioritizingQueue);

/**
 * @name AdministratorHSELinkingStudiesQueue.js
 * @author Kwadwo Sakyi
 * @description Defines the administrator's linkning studies queue component
 */
...
class AdministratorHSELinkingStudiesQueue extends Component {
...
function mapStateToProps({ administratorHSELinkingStudiesQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorHSELinkingStudiesQueue.administratorHSELinkingStudiesQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorHSELinkingStudiesQueue);

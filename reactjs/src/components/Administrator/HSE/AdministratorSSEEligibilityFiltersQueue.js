...
class AdministratorHSEEligibilityFiltersQueue extends Component {
...
function mapStateToProps({ administratorHSEEligibilityFiltersQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorHSEEligibilityFiltersQueue.administratorHSEEligibilityFiltersQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorHSEEligibilityFiltersQueue);

/**
 * @name AdministratorHSEGoLiveQueue.js
 * @author Kwadwo Sakyi
 * @description Defines the administrator's go live queue component
 */
...
class AdministratorHSEGoLiveQueue extends Component {
...
function mapStateToProps({ administratorHSEGoLiveQueue, auth }) {
    return {
        currentUser: auth.currentUser,
        errorMessage: administratorHSEGoLiveQueue.administratorHSEGoLiveQueueErrorMessage,
    }
}

export default connect(mapStateToProps, actions)(AdministratorHSEGoLiveQueue);

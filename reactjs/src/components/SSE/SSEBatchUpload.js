...
*/
    ...
    onSubmit = (event) => {
        ...
        const { submitSSEBatchFile, history } = this.props;

        submitSSEBatchFile(this.state, history);
...
{/*                
                <Container className="container-md">
                    <p className="text-center">SSE Batch Upload Dropzone<br/><small>Drag&apos;n&apos;Drop a sse batch file to upload.</small><br/><small className="spr">Testing content</small><small><a href="http://www.dropzonejs.com/" rel="noopener noreferrer" target="_blank"> test link</a></small></p>
                    ...
                    <div className="col-md-12">
                        <form onSubmit={this.onSubmit.bind(this)} name="formDemo">
                            ...
                            <Card className="card-default">
                                <CardHeader>
                                    <div className="card-title">SSE Article Upload</div>
                                </CardHeader>
                                <CardBody>

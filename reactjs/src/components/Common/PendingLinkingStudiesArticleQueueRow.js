...
class PendingLinkingStudiesArticleQueueRow extends Component {
    ...
    render() {
        ...
        return (
            <tr key={article._id}>
                ...
                <td key={Math.random()}>
                    {article._linkingStudiesJuniorEmail || <a><Swal options={this.state.swalOptionJunior} callback={ (isConfirm) => this.swalCallbackAssignJunior(isConfirm, article._id, history)}  className="mr-1 badge badge-primary">Assign</Swal></a>}
                </td>
...
export default connect(null, actions)(PendingLinkingStudiesArticleQueueRow); 